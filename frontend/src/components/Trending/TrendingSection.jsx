...
const TrendingSection = ({ onLike, onComment, onDelete, onShare, onUserClick, onViewChange }) => {
  const { setCurrentTag } = useFiltered();
              ...
              {trendingHashtags.map((tag, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-gray-800 text-lg">{tag}</p>
                      <p className="text-sm text-gray-600">0 posts</p>
                    </div>
                  </div>
