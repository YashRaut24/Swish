...
import { X, Home, Compass, User, Shield, LogOut, MessageCircle, Bell, Users, Bookmark, Calendar, TrendingUp } from 'lucide-react';
...
const MobileMenu = ({ isOpen, onClose, currentView, onViewChange }) => {
  ...
  const navItems = isAdmin ? [
    { view: VIEWS.ADMIN, icon: Shield, label: 'Admin Dashboard', color: 'text-orange-600' }
  ] : [
    ...
    { view: VIEWS.SAVED, icon: Bookmark, label: 'Saved Posts', color: 'text-green-600' },
  ];
